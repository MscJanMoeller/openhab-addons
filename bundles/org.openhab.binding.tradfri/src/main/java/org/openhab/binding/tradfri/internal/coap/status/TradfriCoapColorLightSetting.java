...
/**
 * The {@link TradfriCoapColorLightSetting} class is a Java wrapper for raw JSON data related to a light bulb
...
@NonNullByDefault
public class TradfriCoapColorLightSetting extends TradfriCoapDimmableLightSetting {
