...
/**
 * The {@link TradfriColorTempLightSetting} class is a Java wrapper for raw JSON data related to a light bulb
...
@NonNullByDefault
public class TradfriColorTempLightSetting extends TradfriDimmableLightSetting {
