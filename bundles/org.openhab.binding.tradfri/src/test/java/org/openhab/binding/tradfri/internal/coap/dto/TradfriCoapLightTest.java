...
public class TradfriCoapLightTest {
    ...
    public void testDimmableLightBulb() {
        ...
        final TradfriCoapLight bulb = Objects.requireNonNull(gson.fromJson(json, TradfriCoapLight.class));
        ...
        final TradfriCoapDeviceInfo devInfo = bulb.getDeviceInfo().get();
        ...
        final TradfriCoapLightSetting bulbInfo = bulb.getLightSetting().get();
    ...
    public void testColorTempLightBulb() {
        ...
        final TradfriCoapLight bulb = Objects.requireNonNull(this.gson.fromJson(json, TradfriCoapLight.class));
